...
//            await ParserHelpers.ReadBytesAsync($"{_exceptionOriginName} - Reading Magic Number", fileStream, int32ByteBuffer, 4);
...
//            await ParserHelpers.ReadBytesAsync($"{_exceptionOriginName} - Reading Length of Spectator client version", fileStream, int32ByteBuffer, 4);
...
//            await ParserHelpers.ReadBytesAsync($"{_exceptionOriginName} - Reading Spectator client version", fileStream, spectatorClientVersionBytes, BitConverter.ToInt32(int32ByteBuffer, 0));

//            header.SpectatorClientVersion = Encoding.UTF8.GetString(spectatorClientVersionBytes);
            
            
//            //// Read the game ID
//            await ParserHelpers.ReadBytesAsync($"{_exceptionOriginName} - Reading Game ID", fileStream, int64ByteBuffer, 8);
//            header.GameID = BitConverter.ToInt64(int64ByteBuffer, 0);


//            //// Read Chunk data
//            await ParserHelpers.ReadBytesAsync($"{_exceptionOriginName} - Reading Chunks", fileStream, int32ByteBuffer, 4);
...
//            //// Read game length
//            await ParserHelpers.ReadBytesAsync($"{_exceptionOriginName} - Reading Game length", fileStream, int32ByteBuffer, 4);
...
//            await ParserHelpers.ReadBytesAsync($"{_exceptionOriginName} - Reading Game region length", fileStream, int32ByteBuffer, 4);
...
//            await ParserHelpers.ReadBytesAsync($"{_exceptionOriginName} - Reading Game region", fileStream, gameRegionBytes, BitConverter.ToInt32(int32ByteBuffer, 0));
//            header.GamePlatform = Encoding.UTF8.GetString(gameRegionBytes);


//            //// Get length of spectator encryption key
//            await ParserHelpers.ReadBytesAsync($"{_exceptionOriginName} - Reading Spectator encryption key length", fileStream, int32ByteBuffer, 4);
...
//            await ParserHelpers.ReadBytesAsync($"{_exceptionOriginName} - Reading Spectator encryption key", fileStream, spectatorEncryptionKeyBytes, BitConverter.ToInt32(int32ByteBuffer, 0));

//            header.SpectatorEncryptionKey = Encoding.UTF8.GetString(spectatorEncryptionKeyBytes);


//            //// Get length of creation time
//            await ParserHelpers.ReadBytesAsync($"{_exceptionOriginName} - Reading creation time length", fileStream, int32ByteBuffer, 4);
...
//            await ParserHelpers.ReadBytesAsync($"{_exceptionOriginName} - Reading creation time", fileStream, creationTimeBytes, BitConverter.ToInt32(int32ByteBuffer, 0));

//            header.CreateTime = Encoding.UTF8.GetString(creationTimeBytes);


//            //// Get length of start time
//            await ParserHelpers.ReadBytesAsync($"{_exceptionOriginName} - Reading start time length", fileStream, int32ByteBuffer, 4);
...
//            await ParserHelpers.ReadBytesAsync($"{_exceptionOriginName} - Reading creation time", fileStream, startTimeBytes, BitConverter.ToInt32(int32ByteBuffer, 0));

//            header.StartTime = Encoding.UTF8.GetString(startTimeBytes);


//            //// Get length of end time
//            await ParserHelpers.ReadBytesAsync($"{_exceptionOriginName} - Reading end time length", fileStream, int32ByteBuffer, 4);

//            //// Use the length of start time to make a new array to put the start time
//            byte[] endTimeBytes = new byte[BitConverter.ToInt32(int32ByteBuffer, 0)];
//            await ParserHelpers.ReadBytesAsync($"{_exceptionOriginName} - Reading end time", fileStream, endTimeBytes, BitConverter.ToInt32(int32ByteBuffer, 0));

//            header.EndTime = Encoding.UTF8.GetString(endTimeBytes);


//            //// Get length of league of legends version
//            await ParserHelpers.ReadBytesAsync($"{_exceptionOriginName} - Reading league of legends version length", fileStream, int32ByteBuffer, 4);

//            //// Use the length of start time to make a new array to put the start time
//            byte[] leagueVersionBytes = new byte[BitConverter.ToInt32(int32ByteBuffer, 0)];
//            await ParserHelpers.ReadBytesAsync($"{_exceptionOriginName} - Reading end time", fileStream, leagueVersionBytes, BitConverter.ToInt32(int32ByteBuffer, 0));
//            // TODO
...
//            await ParserHelpers.ReadBytesAsync($"{_exceptionOriginName} - Reading result boolean", fileStream, resultsExistByte, 1);
//            // TODO
...
//            await ParserHelpers.ReadBytesAsync($"{_exceptionOriginName} - Reading number of players", fileStream, int32ByteBuffer, 4);
//            oldResults.NumberOfPlayers = BitConverter.ToInt32(int32ByteBuffer, 0);

//            //// Read length of player name, use to grab player name
//            await ParserHelpers.ReadBytesAsync($"{_exceptionOriginName} - Reading player name length", fileStream, int32ByteBuffer, 4);

//            byte[] playerNameBytes = new byte[BitConverter.ToInt32(int32ByteBuffer, 0)];
//            await ParserHelpers.ReadBytesAsync($"{_exceptionOriginName} - Reading player name", fileStream, playerNameBytes, BitConverter.ToInt32(int32ByteBuffer, 0));
//            oldResults.PlayerName = Encoding.UTF8.GetString(playerNameBytes);


//            //// Read length of champion name, use to grab champion name
//            await ParserHelpers.ReadBytesAsync($"{_exceptionOriginName} - Reading champion name length", fileStream, int32ByteBuffer, 4);

//            byte[] championNameBytes = new byte[BitConverter.ToInt32(int32ByteBuffer, 0)];
//            await ParserHelpers.ReadBytesAsync($"{_exceptionOriginName} - Reading champion name", fileStream, championNameBytes, BitConverter.ToInt32(int32ByteBuffer, 0));
//            oldResults.ChampionName = Encoding.UTF8.GetString(championNameBytes);


//            //// Reading team
//            await ParserHelpers.ReadBytesAsync($"{_exceptionOriginName} - Reading team", fileStream, int32ByteBuffer, 4);
//            oldResults.Team = BitConverter.ToInt32(int32ByteBuffer, 0);


//            //// Reading client id
//            await ParserHelpers.ReadBytesAsync($"{_exceptionOriginName} - Reading client id", fileStream, int32ByteBuffer, 4);
