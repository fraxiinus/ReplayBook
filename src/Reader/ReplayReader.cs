...
using Fraxiinus.ReplayBook.Reader.Parsers;
using Fraxiinus.ReplayBook.Reader.Models;
using Fraxiinus.ReplayBook.Reader.Utilities;
using Fraxiinus.ReplayBook.Reader.Models.Internal.ROFL;
using System.Linq;

namespace Fraxiinus.ReplayBook.Reader
{
    ...
    public class ReplayReader
    {
        ...
        public async Task<ReplayFile> ReadFile(string filePath)
        {
            ...
            switch (type)
            {
                ...
                //    break;
                default:
                    throw new ArgumentException($"File {filePath} is not an accepted format: rofl");
            }
